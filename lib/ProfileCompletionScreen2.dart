...
import 'login.dart';// Make sure this import points to your DynamicHomeScreen file

class GreenProfileForm2 extends StatefulWidget {
  final String? name;
  final String? email;
  final String? photoUrl;

  const GreenProfileForm2({
    super.key,
    this.name,
    this.email,
    this.photoUrl,
  ...
  @override
  State<GreenProfileForm2> createState() => _GreenProfileFormState();
}

class _GreenProfileFormState extends State<GreenProfileForm2> {
